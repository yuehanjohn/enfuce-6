...
CREATE INDEX IF NOT EXISTS idx_l1_customer ON SCREENING.LAYER1_FLAGS(customer_id);
CREATE INDEX IF NOT EXISTS idx_l1_entity ON SCREENING.LAYER1_FLAGS(entity_id);
