...
CREATE INDEX IF NOT EXISTS idx_q_status ON QUEUE.PENDING_REVIEW(status);
CREATE INDEX IF NOT EXISTS idx_q_confidence ON QUEUE.PENDING_REVIEW(ai_confidence);
